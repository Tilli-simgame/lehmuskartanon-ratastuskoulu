...
<div class="guestbook-container">
    ...
    <div class="guestbook-rules">
        <p>Täällä leiriläiset ja vaeltajat voivat jakaa kokemuksiaan! Kirjaa ylös leiri- tai vaellusmuistosi ja kerro muille, miten meni.</p>
    </div>

    <div class="gb-pagination">
        <div class="pagination-cell">
            <a href="{{ '/toiminta/leirit.html' | relative_url }}">Takaisin Leirit -sivulle</a>
        </div>
        <div class="pagination-cell">
        ...
        <div class="pagination-cell">
            <a href="{{ '/toiminta/lokikirja/kirjoita.html' | relative_url }}">Kirjoita lokikirjaan</a>
        </div>
        <div class="pagination-cell">
            ...
            messagesList.innerHTML = messages.map(m => `
                <div class="message-item">
                    <div class="message-meta">
                        ...
                        ${m.event_type ? `<div class="meta-row"><span class="meta-label">Tapahtuma :</span> <span class="meta-value">${escapeHtml(m.event_type)}</span></div>` : ''}
                        <div class="meta-row" style="margin-top: 15px;"><span class="meta-label">Kertomus :</span> <span class="meta-value">${escapeHtml(m.message)}</span></div>
                    </div>
